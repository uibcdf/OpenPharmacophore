...
def test_append_filters_to_url():
    ...
    full_url = client._append_filters_to_url(substances_url, "smi", count=1000, availability="for-sale",
                                             reactivity="anodyne")
...
def test_get_catalog_url():
    ...
    catalog_name = "Asinex"
    assert client._get_catalog_url(file_name, catalog_name,
                                   count="all") == "https://zinc.docking.org/catalogs/asin/substances.smi?count=all"
