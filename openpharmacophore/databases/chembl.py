...
class ChemBl():
    ...
    def get_ro5_dataset(self, download_dir):
    ...
    def get_bioactivity_data(self, target_chembl_id):
    ...
    def get_training_data(self, target_chembl_id, pIC50_threshold=6.3):
        ...
        """
        bioactivities_df = self.get_bioactivity_data(target_chembl_id=target_chembl_id)
